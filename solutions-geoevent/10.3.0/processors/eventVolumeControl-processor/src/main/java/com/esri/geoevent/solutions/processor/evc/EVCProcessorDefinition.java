...
public class EVCProcessorDefinition extends GeoEventProcessorDefinitionBase
{
	...
	public EVCProcessorDefinition()
	{
		try {
			...
			List<AllowedValue> allowedVals = new ArrayList<AllowedValue>();
			allowedVals.add(new AllowedValue(allowedValInterval,"byInterval"));
			allowedVals.add(new AllowedValue(allowedValMaxPerInterval,"maxPerInterval"));
