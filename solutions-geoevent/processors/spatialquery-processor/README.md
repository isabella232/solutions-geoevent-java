...
* In the TCP-console you will see that the Received Event (Event Definition name) is QueryReportTest with a comma separated list of values. If using the refugee_camps service a total of 5 events will be generated by the processor - one for each feature returned by the spatial query.
