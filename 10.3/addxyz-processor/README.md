...
![Image of AddXYZ Processor]AddXYZ_Processor.PNG

## Features 


* AddXYZ Processor - The AddXYZ processor takes as an input a geoevent with a point geometry and adds x, y, and z fields/values to the resulting geoevent.  Useful when coordinate values are required for mathematical calculations in the geoevent.
...
* Open a command prompt and navigate to `solutions-geoevent-java/solutions-geoevent/processors/addXYZ-processor`
    * Enter `mvn install` at the prompt.

## Installation

* Install the AddXYZ Processor.
    * Browse to `solutions-geoevent-java/solutions-processors/addXYZ-processor/target` (this directory is created when you execute mvn install).
...
![Image of service](doc/addXYZ-simple-service.png)
