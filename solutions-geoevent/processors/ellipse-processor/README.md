...
* The following example configures the Ellipse Processor, the other processors can be configured in a similar manner.
...
* Using the GeoEvent Simulator, load the simulation file located at  solutions-geoevent-java\data\simulation_files\ellipse.csv
