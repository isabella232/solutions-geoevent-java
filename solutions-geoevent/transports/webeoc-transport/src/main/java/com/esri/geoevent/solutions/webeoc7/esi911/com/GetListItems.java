...
public class GetListItems  implements java.io.Serializable {
    ...
    /**
     * Gets the credentials value for this GetListItems.
     * 
     * @return credentials
     */
    ...
    /**
     * Sets the credentials value for this GetListItems.
     * 
     * @param credentials
     */
    ...
    /**
     * Gets the listId value for this GetListItems.
     * 
     * @return listId
     */
    ...
    /**
     * Sets the listId value for this GetListItems.
     * 
     * @param listId
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com:esi911:webeoc7:api:1.0", ">GetListItems"));
