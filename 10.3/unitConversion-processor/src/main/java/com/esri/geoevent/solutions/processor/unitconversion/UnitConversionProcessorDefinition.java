	...
	public void setManager(GeoEventDefinitionManager m, TagManager tm) {
		...
		try {
			...
			PropertyDefinition pdVMan = new PropertyDefinition("velocity-manual",
					PropertyType.String, null, lblVelField,
			...
			PropertyDefinition pdVOut = new PropertyDefinition("vout", PropertyType.String, "${com.esri.geoevent.solutions.processor.unitconversion.unitConversion-processor.VELOCITY_MILES_PER_HOUR}", lblVelOutputUnit, descVelOutputUnit, false, false, allowedVelocities);
			propertyDefinitions.put(pdVOut.getPropertyName(), pdVOut);
			
			PropertyDefinition pdAInputType = new PropertyDefinition("input-a", PropertyType.String, "${com.esri.geoevent.solutions.processor.unitconversion.unitConversion-processor.INPUT_FIELD_LBL}", lblAltInputType, descAltInputType, false, false, allowedInputs);
			...
			PropertyDefinition pdAMan = new PropertyDefinition("alt-manual",
					PropertyType.String, null, lblAltField,
					descAltField, false, false);
			...
			PropertyDefinition pdAltOut = new PropertyDefinition("altout", PropertyType.String, "${com.esri.geoevent.solutions.processor.unitconversion.unitConversion-processor.ALTITUDE_METERS}", lblAltOutputUnit, descAltOutputUnit, false, false, allowedAltitudes);
			propertyDefinitions.put(pdAltOut.getPropertyName(), pdAltOut);
			
			PropertyDefinition pdFInputType = new PropertyDefinition("input-f", PropertyType.String, "${com.esri.geoevent.solutions.processor.unitconversion.unitConversion-processor.INPUT_FIELD_LBL}", lblFreqInputType, descFreqInputType, true, false, allowedInputs);
			...
			PropertyDefinition pdFMan = new PropertyDefinition("freq-manual",
					PropertyType.String, null, lblFreqField, descFreqField, false, false);
			...
			PropertyDefinition pdFOut = new PropertyDefinition("freqout", PropertyType.String, "${com.esri.geoevent.solutions.processor.unitconversion.unitConversion-processor.FREQUENCY_HERTZ}", lblFreqOutputUnit, descFreqOutputUnit, false, false, allowedFrequencies);
