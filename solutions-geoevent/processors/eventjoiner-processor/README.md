...
*Create a second input service
    * The second service should be configured as follows

![Image of Input Service](doc/input-service2.png)
    *(TIP: use the copy service button next to the first service you created and modify only those properties as necessary.)
