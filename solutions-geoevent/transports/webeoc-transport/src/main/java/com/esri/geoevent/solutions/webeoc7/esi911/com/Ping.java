...
public class Ping  implements java.io.Serializable {
    ...
    /**
     * Gets the credentials value for this Ping.
     * 
     * @return credentials
     */
    ...
    /**
     * Sets the credentials value for this Ping.
     * 
     * @param credentials
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com:esi911:webeoc7:api:1.0", ">Ping"));
