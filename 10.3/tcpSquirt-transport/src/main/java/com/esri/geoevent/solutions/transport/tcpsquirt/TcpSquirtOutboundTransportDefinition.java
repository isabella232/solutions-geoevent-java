...
public class TcpSquirtOutboundTransportDefinition extends TransportDefinitionBase
{
	...
	public TcpSquirtOutboundTransportDefinition()
	{
		...
		try
		{
			...
			List<AllowedValue> allowedModes = new ArrayList<AllowedValue>();
			allowedModes.add(new AllowedValue("${com.esri.geoevent.solutions.transport.tcpsquirt.tcpsquirt-transport.ALLOWED_MODE_SERVER}", "SERVER"));
			allowedModes.add(new AllowedValue("${com.esri.geoevent.solutions.transport.tcpsquirt.tcpsquirt-transport.ALLOWED_MODE_CLIENT}", "CLIENT"));
